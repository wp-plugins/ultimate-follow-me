	  ...
	  ?>
      	<table>
            ...
            <tr>
                ...
                <td valign="bottom"><input name="uf_fb_id" type="text" value="<?php echo $data['uf_fb_id']; ?>" /></td>
            </tr>
            <tr>
                <td align="right"><label>Twitter username <small>(http://www.twitter.com/<u>username</u>)</small>:</label></td>
                <td><input name="uf_tw_id" type="text" value="<?php echo $data['uf_tw_id']; ?>" /></td>
            </tr>
            <tr>
	  			
                <td align="right"><label>Youtube username <small>(http://www.youtube.com/<u>username</u>)</small>:</label></td>
                <td><input name="uf_yt_id" type="text" value="<?php echo $data['uf_yt_id']; ?>" /></td>
            </tr>
<tr>
	  			
                <td align="right"><label>Linkedin username <small>(http://www.linkedin.com/in/<u>username</u>)</small>:</label></td>
                <td><input name="uf_li_id" type="text" value="<?php echo $data['uf_li_id']; ?>" /></td>
            </tr>              
<tr>
                <td align="right"><label>Email address or URL to contact us page:</label></td>
                <td><input name="uf_email_address" type="text" value="<?php echo $data['uf_email_address']; ?>" /></td>
            </tr> 
            <tr>
...
<tr>
  ...
  function widget($args){
    ...
    echo $args['before_title'] . 'Follow me on the web!' . $args['after_title'];
    	  $data = get_option('ultimate_follow_me');
